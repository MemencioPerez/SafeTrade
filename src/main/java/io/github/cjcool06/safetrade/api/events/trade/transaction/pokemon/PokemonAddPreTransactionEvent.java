 ...
 */
public class PokemonAddPreTransactionEvent extends PokemonTransactionEvent implements Cancellable {

    private static final HandlerList handlers = new HandlerList();
    private boolean cancel = false;

    public PokemonAddPreTransactionEvent(Vault vault, Pokemon pokemon) {
        super(vault, pokemon);
    }
