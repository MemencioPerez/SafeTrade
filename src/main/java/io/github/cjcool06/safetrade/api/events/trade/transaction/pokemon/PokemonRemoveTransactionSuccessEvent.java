 ...
 */
public class PokemonRemoveTransactionSuccessEvent extends PokemonTransactionEvent {

    private static final HandlerList handlers = new HandlerList();

    public PokemonRemoveTransactionSuccessEvent(Vault vault, Pokemon pokemon) {
        super(vault, pokemon);
    }
